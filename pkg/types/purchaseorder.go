...
type PurchaseOrder struct {
	...
	TransactionLocationType *string               `json:"TransactionLocationType,omitempty"` // Applies to minorVersion 4
	...
	EmailStatus             *string               `json:"EmailStatus,omitempty"`  // Applies to minorVersion 45
